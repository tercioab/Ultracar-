export default function Footer() {
	return (
		<footer class='p-4 bg-white  shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 fixed bottom-0 w-full bg-white border-t-2 border-blue-2'>
